...
// Route::get('faq', 'App\Http\Controllers\UsersController@faq');
...
// Route::get('faqdetail/{id_kategori}/{id_subkategori}', 'App\Http\Controllers\UsersController@faqdetail')->name('faq.detail');
...
// Route::get('pengaduan', 'App\Http\Controllers\UsersController@pengaduan');
// Route::post('pengaduan/create', 'App\Http\Controllers\UsersController@InputPengaduan');
...
Route::group(['middleware' => ['auth', 'CheckRole:1']], function(){
		Route::get('/dashboard', 'App\Http\Controllers\AdminController@dashboard')->name('home');
