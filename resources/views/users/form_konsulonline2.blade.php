          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary" style="width: 500px;">
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-prevent" action="{{ action('App\Http\Controllers\UsersController@create_konsul') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                    <!-- {{csrf_field()}} -->
                    ...
                    <div class="form-group">
                          ...
                          <textarea id="summernote" name="details" class="form-control" rows="3" placeholder="Enter ..." required></textarea>
