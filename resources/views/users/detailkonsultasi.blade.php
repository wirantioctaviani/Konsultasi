...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('/vesperassets/css/timeline.css')}}" />
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="{{ action('App\Http\Controllers\UsersController@formkonsul') }}">Formulir Konsultasi Online</a></li>
        </ul>
      ...
      <div class="container" >
        ...
        <div class="row">
          ...
          <div class="col-lg-10 col-md-12" data-aos="fade-up" data-aos-delay="300" style="border: 2px solid #00b4cc;background-color: #f7fbfe;">
                ...
                <div class="create-post-wrapper">
                    <div class="form-group">
                        <div class="row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-md-7"><input name="no_tiket" type="text" class="form-control post-input" value="{{$data_konsul_online->no_tiket}}" disabled></div>
                            <!-- <div class="col-md-1"></div> -->
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-md-1" style="color:black;">:</div>
                            <div class="col-md-7"><input name="nama" type="text" class="form-control post-input" value="{{$data_konsul_online->nama}}" disabled></div>
                            <!-- <div class="col-md-1"></div> -->
                        </div>
                    </div>
                    <div class="form-group">
                      <div class="row" style="margin-bottom: 10px;">
                          ...
                          <div class="col-md-1" style="color:black;">:</div>
                          <div class="col-md-7"><input name="jabatan" type="text" class="form-control post-input" id="exampleInputnama" value="{{$data_konsul_online->unit_kerja}}" disabled></div>
                          <!-- <div class="col-md-1"></div> -->
                      </div>
                  </div>
                  <div class="form-group">
                      <div class="row" style="margin-bottom: 10px;">
                          ...
                          <div class="col-md-1" style="color:black;">:</div>
                          <div class="col-md-7"><input name="unit_kerja" type="text" class="form-control post-input" id="exampleInputnama" value="{{$data_konsul_online->jabatan}}" disabled></div>
                          <!-- <div class="col-md-1"></div> -->
                      </div>
                  </div>
                  <div class="form-group">
                      <div class="row" style="margin-bottom: 10px;">
                          ...
                          <div class="col-md-1" style="color:black;">:</div>
                          <div class="col-md-7"><input name="no_hp" type="text" class="form-control post-input" id="exampleInputnama" value="{{$data_konsul_online->jenis_layanan}}" disabled></div>
                          <!-- <div class="col-md-1"></div> -->
                      </div>
                  </div>
                  <div class="form-group">
                      <div class="row" style="margin-bottom: 10px;">
                          ...
                          <div class="col-md-7">
                            ...
                            <input name="judul" type="text" class="form-control post-input" id="exampleInputEmail1" value="{{$data_konsul_online->judul}}" disabled>
                          </div>
                          <!-- <div class="col-md-1"></div> -->
                      </div>
                  </div> 
                        ...
                        @foreach($data_konsul_detail as $data_konsul_detail)
                          <li>
                             ...
                             <div class="timeline-time">
                                <span class="date">{{date("d M Y", strtotime($data_konsul_detail->created_at))}}</span>
                                <span class="time">{{date("H:i", strtotime($data_konsul_detail->created_at))}}</span>
                             </div>
                             <!-- end timeline-time -->
                             <!-- begin timeline-icon -->
                             ...
                             <div class="timeline-body">
                                <div class="timeline-header">
                                   ...
                                   <span class="username"><a href="javascript:;">{{$data_konsul_detail->created_by}}</a> <small></small></span>
                                </div>
                                ...
                                @if($data_konsul_detail->dokumen != null)
                                  <div class="timeline-footer">
                                     <label class="">Dokumen Pendukung    : </label>
                                      <a href="{{ url('/').'/dokumen/'.$data_konsul_detail->dokumen }}" style="color:skyblue;" target="_blank">{{ $data_konsul_detail->dokumen }}</a>
                                  </div>
                                @endif
                             </div>
                             <!-- end timeline-body -->
              ...
              @elseif($data_konsul_online->status_id == '3')
                <div class="panel-body">
                    <div class="col text-center">
              ...
              @elseif($data_konsul_online->status_id == '4')
                <div class="panel-body">
                    <div class="col text-center">
                                        <!-- <button type="submit" onclick="return confirm('Close Konsultasi?')" class="btn btn-primary btn-lg" >Close Case</button> -->
        ...
        <!--          <h3>Vesperr</h3>
              ...
              <div class="modal fade" id="modal-ratting" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form class="form-prevent" action="{{ action('App\Http\Controllers\UsersController@store_rating', [$data_konsul_detail->id_konsul]) }}" method="POST">
                    @csrf
