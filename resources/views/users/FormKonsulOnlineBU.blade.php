    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ action('App\Http\Controllers\UsersController@konsul_online') }}" class="nav-link {{ (request()->is('konsul_online')) ? 'active' : '' }}">
              <i class="nav-icon fas fa-home"></i>
              <p>Form Konsultasi Online</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ action('App\Http\Controllers\UsersController@list_konsul_online') }}" class="nav-link {{ (request()->is('list_konsul_online')) ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ action('App\Http\Controllers\UsersController@pengaduan') }}" class="nav-link {{ (request()->is('pengaduan')) ? 'active' : '' }}">
              <i class="nav-icon fas fa-copy"></i>
              <p>
                Form Pengaduan
              </p>
