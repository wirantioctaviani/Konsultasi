...
<html lang="en">
	...
	<head><base href="">
		...
		<link rel="shortcut icon" href="{{asset('adminlte/dist/img/pusbin.png')}}" />
		<!--begin::Fonts-->
	...
	<body id="kt_body" class="header-extended header-fixed header-tablet-and-mobile-fixed">
								...
								<div class="d-flex flex-stack align-items-stretch w-100">
									...
									<div class="d-flex align-items-center align-items-lg-stretch me-5">
										...
										<a href="" class="d-flex align-items-center">
											<img alt="Logo" src="{{asset('/adminlte/dist/img/bpkp.png')}}" class="h-25px h-lg-30px" />
										</a>
										<!--end::Logo-->
										...
										<div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
											...
											<div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
												...
												<div class="symbol symbol-30px symbol-md-40px">
													<img src="{{asset('metronic/media/avatars/150-26.jpg')}}" alt="image" />
												</div>
												<!--end::Symbol-->
											</div>
											<!--end::User info-->
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="symbol symbol-50px me-5">
															<img alt="Logo" src="{{asset('metronic/media/avatars/150-26.jpg')}}" />
														</div>
														<!--end::Avatar-->
														<!--begin::Username-->
									...
									<div class="mb-18">
										...
										<div class="mb-10">
											...
											<div class="text-center mb-15">
												<!--begin::Text-->
												<div class="fs-5 text-muted fw-bold">{{$mytime}} <span id="span"></span></div>
												<!--end::Text-->
												<!--begin::Title-->
		...
		<script src="{{asset('metronic/js/custom/modals/create-campaign.js')}}"></script>
		<script src="{{asset('metronic/js/custom/modals/create-app.js')}}"></script>
		<script src="{{asset('metronic/js/custom/modals/users-search.js')}}"></script>
