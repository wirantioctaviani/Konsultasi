        ...
        <div class="row" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="icon-box" style="height: 100px;background-color: white;border: 2px solid #00b4cc;">
              ...
              <h3><a href="{{ action('App\Http\Controllers\UsersController@detailfaq', ['layanan_id' => 5, 'id_kategori' => 1, 'id_subkategori' => 1]) }}">Aplikasi SIBIJAK</a></h3>
            </div>
          </div>
        </div>
      ...
      <div class="container" >
        ...
        <div class="row">
          ...
          <div class="col-lg-10 col-md-12" data-aos="fade-up" data-aos-delay="300" style="border: 2px solid #00b4cc;background-color: #f7fbfe;">
            <form class="needs-validation form-prevent"  action="{{ action('App\Http\Controllers\UsersController@create_konsul') }}" role="form" name="form" method="POST" enctype="multipart/form-data" novalidate>
              @csrf
                <br>
            ...
            @foreach($data_konsul_online as $data_konsul_online)
              <div class="col-md-3 align-items-stretch " >
                <div class="icon-box text-center" data-aos="fade-up" data-aos-delay="100" style="margin-bottom:20px;height: 180px;">
                  <h4 class="title" style="font-size:12px"><a href="">{{$data_konsul_online->jenis_layanan}}</a></h4>
                  <span data-purecounter-start="0" data-purecounter-end="{{$data_konsul_online->jumlah}}" data-purecounter-duration="1" style="font-size: 35px;" class="purecounter"></span>
                  <div class="row">
                    @foreach($open as $opens)
                      @if($opens->layanan_id == $data_konsul_online->layanan_id)
                        <div class="col col-md-4">
                          <span data-purecounter-start="0" data-purecounter-end="{{$opens->jumlahopen}}" data-purecounter-duration="1" style="font-size: 14px;color: red;" class="purecounter"></span>
                          <h4 class="title" style="font-size:10px;color: red";><i>Open </i></h4>
                        </div>
                      @endif
                    @endforeach
                    @foreach($proses as $prosess)
                      @if($prosess->layanan_id == $data_konsul_online->layanan_id)
                        <div class="col col-md-4">
                          <span data-purecounter-start="0" data-purecounter-end="{{$prosess->jumlahproses}}" data-purecounter-duration="1" style="font-size: 14px;color: #fcba03;" class="purecounter"></span>
                          <h4 class="title" style="font-size:10px;color: #fcba03";>Proses</h4>
                        </div>
                        @endif
                    @endforeach
                    @foreach($closed as $close)
                      @if($close->layanan_id == $data_konsul_online->layanan_id)
                        <div class="col col-md-4">
                          <span data-purecounter-start="0" data-purecounter-end="{{$close->jumlahclosed}}" data-purecounter-duration="1" style="font-size: 14px;color:green;" class="purecounter"></span>
