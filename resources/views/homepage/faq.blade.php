...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><img src="{{asset('/vesperassets/img/bpkp.png')}}" alt="" class="img-fluid"></a></h1>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title text-center">
                            <a data-toggle="collapse" href="#collapse1" style="font-size:20px;color: black;">{{$kategoris->nama_kategori}}</a>
                          </h4>
                        </div>
                        <div id="collapse1" class="panel-collapse collapse show">
                          <ul class="list-group">
                            @foreach($subkategori as $subkategoris)
                              @if($subkategoris->id_kategori == $kategoris->id_kategori)
                                <li class="list-group-item"><a href="{{ action('App\Http\Controllers\UsersController@detailfaq', [$subkategoris->id_subkategori]) }}">{{$subkategoris->nama_subkategori}}</a></li>
                              @endif
                            @endforeach
                          </ul>
                        </div>
