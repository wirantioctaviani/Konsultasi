                ...
                <div class="border-right vh-100" id="sidebar-wrapper" style="width:20rem;background-color: transparent;">
                    <div class="list-group overflow-auto h-100" style="color:#f7fbfe;background-color: transparent;">
                      @foreach($kategori as $kategoris)
                        <label class="list-group-item " style="border: 0px;background-color: transparent;"><b>{{$kategoris->nama_kategori}}</b></label>
                            @foreach($subkategori as $subkategoris)
                              @if($subkategoris->kategori_id == $kategoris->id_kategori)
                                <div class="row">
                                  <div class="col-md-2"></div>
                                    <div class="col-md-10">
                                      <a href="{{ action('App\Http\Controllers\UsersController@detailfaq', ['layanan_id' => 5, 'id_subkategori' => $subkategoris->id_subkategori]) }}" class="list-group-item menus" style="border: 0px;background-color: transparent;">{{$subkategoris->nama_subkategori}}</a>
                                    </div>
                                </div>
                              @endif
                            @endforeach
            ...
            <div class="d-flex" id="wrapper">
                <div id="page-content-wrapper">
                    <div class="container-fluid" style="margin-top:30px;border: 1px solid #00b4cc;background-color: white;">
                        <h2 class="judul text-center" style="margin-top: 20px;margin-bottom: 20px;"><b>{{$subkategorishow->nama_subkategori}}</b></h2>
                        <br>
                        <p class="jawaban" style="text-align: justify;">{!!$subkategorishow->jawaban!!}</p>
                    </div>
                </div>
