        ...
        <div class="row" style="border: 2px solid #00b4cc;background-color: #f7fbfe;height: auto;">
          <div class="col-md-4">
            <div class="d-flex" id="wrapper">
              <!-- Sidebar -->
                <div class="border-right vh-100" id="sidebar-wrapper" style="width:20rem;background-color: transparent;">
                    <div class="list-group overflow-auto h-100" style="color:#f7fbfe;background-color: transparent;">
                      <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategoris): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="list-group-item " style="border: 0px;background-color: transparent;"><b><?php echo e($kategoris->nama_kategori); ?></b></label>
                            <?php $__currentLoopData = $subkategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subkategoris): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($subkategoris->kategori_id == $kategoris->id_kategori): ?>
                                <div class="row">
                                  <div class="col-md-2"></div>
                                    <div class="col-md-10">
                                      <a href="<?php echo e(action('App\Http\Controllers\UsersController@detailfaq', ['layanan_id' => 5, 'id_subkategori' => $subkategoris->id_subkategori])); ?>" class="list-group-item menus" style="border: 0px;background-color: transparent;"><?php echo e($subkategoris->nama_subkategori); ?></a>
                                    </div>
                                </div>
                              <?php endif; ?>
          ...
          <div class="col-md-8">
            <div class="d-flex" id="wrapper">
                <div id="page-content-wrapper">
                    <div class="container-fluid" style="margin-top:30px;border: 1px solid #00b4cc;background-color: white;">
                        <h2 class="judul text-center" style="margin-top: 20px;margin-bottom: 20px;"><b><?php echo e($subkategorishow->nama_subkategori); ?></b></h2>
                        <br>
                        <p class="jawaban" style="text-align: justify;"><?php echo $subkategorishow->jawaban; ?></p>
                    </div>
                </div>
...
</html><?php /**PATH D:\web\konsultasi\resources\views/homepage/detailfaq2.blade.php ENDPATH**/ ?>