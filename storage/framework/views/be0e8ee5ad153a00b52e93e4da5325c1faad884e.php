            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <?php $__currentLoopData = $data_konsul_online; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_konsul_online): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <form class="form-prevent" action="<?php echo e(action('App\Http\Controllers\AdminController@changepic_proses', [$data_konsul_online->id_konsul])); ?>" method="post">
                      ...
                      <?php if(Auth::user()->mstr_role_id == "1" || Auth::user()->mstr_role_id == "3"): ?>
                      <div class="form-group row">
                        <div class="col-sm-2">
                        </div>
                      ...
                      <?php if(Auth::user()->mstr_role_id = "4"): ?>
                        <?php if(Auth::user()->subbid_id == "11" || Auth::user()->subbid_id == "21"): ?>
                          <div class="form-group row">
                            <div class="col-sm-2">
                            </div>
                            <label class="col-sm-2 col-form-label">New PIC : </label>
...
<?php echo $__env->make('admin.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\webapp\webpusbin2021\public\konsultasi\resources\views/admin/changepic.blade.php ENDPATH**/ ?>