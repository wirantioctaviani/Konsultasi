  ...
  <main id="main">
    ...
    <section id="faq" class="pricing section-bg">
      <div class="container">
        ...
        <div class="row" >
          <p><b>Hasil pencarian sebanyak 3</b></p>
          <div class="col-md-6" style="height:auto; margin-bottom: 20px;">
            <div class="box" data-aos="zoom-in-right" data-aos-delay="200" style="background-color: white;border: 2px solid #00b4cc;">
              <p style="text-align:left;font-size: 20px;"><a href="">Cara Pengisian Saldo Awal PAK</a></p>
...
</html><?php /**PATH D:\web\konsultasi\resources\views/hasilpencarian.blade.php ENDPATH**/ ?>