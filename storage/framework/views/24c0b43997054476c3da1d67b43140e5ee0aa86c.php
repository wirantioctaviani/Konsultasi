            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <?php $__currentLoopData = $data_konsul_online; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_konsul_online): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   ...
                   <?php if(auth()->user()->mstr_role_id == '3' && $data_konsul_online->status_id == '2'): ?>
                  <div class="panel-body">
                    <div class="col text-center">
                        <form action="<?php echo e(action('App\Http\Controllers\AdminController@approve_konsulonline', [$data_konsul_detail->id_konsul])); ?>" method="post">
                        ...
                        <div class="accordion" id="accordionExample">
                          <div class="card">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                              <div class="card-body">
                                <form action="<?php echo e(action('App\Http\Controllers\AdminController@revisi_konsulonline', [$data_konsul_detail->id_konsul])); ?>" method="post" enctype="multipart/form-data">
              ...
              <?php if(auth()->user()->mstr_role_id == '4' && $data_konsul_online->status_id == '1'): ?>
                  <div class="row">
                    <div class="col-md-2">
                    </div>
                    <div class="col-md-8">
                      <div class="container-fluid">
                        <div class="accordion" id="accordionExample">
                          <div class="card">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                              <div class="card-body">
                                <form action="<?php echo e(action('App\Http\Controllers\AdminController@reply_konsulonline', [$data_konsul_detail->id_konsul])); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\bitnami73\apache2\htdocs\public\konsultasi\resources\views/admin/respon2_konsulonline.blade.php ENDPATH**/ ?>