  ...
  <main id="main">
    ...
    <section id="faq" class="pricing section-bg">
      <div class="container">
        ...
        <div class="row" >
          <p><b>Hasil pencarian sebanyak : <?php echo e($count->jumlahpencarian); ?></b></p>
            <?php $__empty_1 = true; $__currentLoopData = $cari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caris): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <div class="col-md-6" style="height:auto; margin-bottom: 20px;">
                <div class="box" data-aos="zoom-in-right" data-aos-delay="200" style="background-color: white;border: 2px solid #00b4cc;">
                  <p style="text-align:left;font-size: 20px;"><a href="<?php echo e(action('App\Http\Controllers\UsersController@detailfaq', ['layanan_id' => $caris->layanan_id, 'id_kategori' => $caris->id_kategori, 'id_subkategori' => $caris->id_subkategori])); ?>"><?php echo e($caris->nama_subkategori); ?></a></p>
                  <p style="text-align:left;font-size: 16px;"><i class="fa fa-list-alt" aria-hidden="true"></i> <?php echo e($caris->jenis_layanan); ?></p>
                </div>
              </div>
...
</html><?php /**PATH D:\web\konsultasi\resources\views/homepage/hasilpencarian.blade.php ENDPATH**/ ?>