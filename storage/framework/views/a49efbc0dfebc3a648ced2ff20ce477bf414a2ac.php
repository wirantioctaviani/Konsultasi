  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo e(action('App\Http\Controllers\LoginController@logout')); ?>" class="nav-link">LOGOUT</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex" align="center">
        ...
        <div class="info" align="center">
          <a href="#" class="d-block"><?php echo e(request()->session()->get('namalengkap')); ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php if(request()->session()->get('level') == '1'): ?>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="<?php echo e(action('App\Http\Controllers\FaqController@managefaq')); ?>" class="nav-link <?php if($active=='faq'): ?> active <?php endif; ?>">
...
<?php /**PATH D:\web\konsultasi\resources\views/admin/master2.blade.php ENDPATH**/ ?>