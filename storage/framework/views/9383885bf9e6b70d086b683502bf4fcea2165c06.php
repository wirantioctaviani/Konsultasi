    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="<?php echo e(action('App\Http\Controllers\UsersController@formkonsul')); ?>">BERANDA</a></li>
        </ul>
        ...
        <div class="container-fluid" id="main" style="border: 2px solid #00b4cc;background-color: #f7fbfe;height: auto;margin-top: 10px;margin-bottom: 20px;">
            <div class="row row-offcanvas row-offcanvas-left vh-100">
                <div class="col-md-3 h-100 overflow-auto bg-light" id="sidebar" role="navigation" >  
                  <div class="sidebar-heading" style="margin-top:20px;margin-bottom: 20px;margin-left: 10px;font-size: 18px;"><b><?php echo e($subkategorishow->jenis_layanan); ?></b> </div>
                  <hr>
                  <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategoris): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <ul class="nav flex-column mt-4" style="background-color:transparent;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="" style="color: black" data-toggle="collapse" data-target="#menu<?php echo e($kategoris->id_kategori); ?>"><b><?php echo e($kategoris->nama_kategori); ?>▾</b></a>
                              <?php if($kategoris->id_kategori == $id_kategori): ?>
                              <!-- <label>ada</label> -->
                                <ul class="list-unstyled flex-column pl-6" id="menu<?php echo e($kategoris->id_kategori); ?>" aria-expanded="false">
                                  <?php $__currentLoopData = $subkategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subkategoris): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($subkategoris->kategori_id == $kategoris->id_kategori): ?>
                                        <li class="nav-item"><a class="nav-link <?php if($id_subkategori==$subkategoris->id_subkategori): ?> active <?php endif; ?>" href="<?php echo e(action('App\Http\Controllers\UsersController@detailfaq', ['layanan_id' => $subkategoris->layanan_id, 'id_kategori' => $subkategoris->kategori_id, 'id_subkategori' => $subkategoris->id_subkategori
                                          ])); ?>"><?php echo e($subkategoris->nama_subkategori); ?></a></li>
                              ...
                              <?php else: ?>
                              <!-- <label>nda ada</label> -->
                                <ul class="list-unstyled flex-column pl-6 collapse" id="menu<?php echo e($kategoris->id_kategori); ?>" aria-expanded="false">
                                  <?php $__currentLoopData = $subkategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subkategoris): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($subkategoris->kategori_id == $kategoris->id_kategori): ?>
                                        <li class="nav-item"><a class="nav-link <?php if($id_subkategori==$subkategoris->id_subkategori): ?> active <?php endif; ?>" href="<?php echo e(action('App\Http\Controllers\UsersController@detailfaq', ['layanan_id' => $subkategoris->layanan_id, 'id_kategori' => $subkategoris->kategori_id, 'id_subkategori' => $subkategoris->id_subkategori
                                          ])); ?>"><?php echo e($subkategoris->nama_subkategori); ?></a></li>
                ...
                <div class="col main h-100 overflow-auto">
                    <h2 class="sub-header mt-3 text-center"><?php echo e($subkategorishow->nama_subkategori); ?></h2>
                    <hr>
                    <div class="mb-3">
                        <div class="card-deck">
                            <div class="card card-inverse card-success ">
                                <div class="card-body">
                                    <blockquote class="card-blockquote">
                                        <p style="text-align:justify;"><?php echo $subkategorishow->jawaban; ?></p>
                                    </blockquote>
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH D:\web\konsultasi\resources\views/homepage/detailfaq.blade.php ENDPATH**/ ?>