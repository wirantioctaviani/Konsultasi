                          ...
                          <ul class="list-group">
                            <?php $__currentLoopData = $subkategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subkategoris): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($subkategoris->id_kategori == $kategoris->id_kategori): ?>
                                <li class="list-group-item"><a href="<?php echo e(action('App\Http\Controllers\UsersController@detailfaq', [$subkategoris->id_subkategori])); ?>"><?php echo e($subkategoris->nama_subkategori); ?></a></li>
                              <?php endif; ?>
...
</html><?php /**PATH D:\web\konsultasi\resources\views/homepage/faq.blade.php ENDPATH**/ ?>