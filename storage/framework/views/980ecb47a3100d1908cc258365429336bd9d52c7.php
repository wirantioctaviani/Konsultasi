            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <?php $__currentLoopData = $data_konsul_online; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_konsul_online): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <?php if(request()->session()->get('level') == "1" || request()->session()->get('level') == "3"): ?>
                      <div class="form-group row">
                        <div class="col-sm-2">
                        </div>
                      ...
                      <?php if(request()->session()->get('level') == "4"): ?>
                        <?php if(request()->session()->get('subbid') == "11" || request()->session()->get('subbid') == "21"): ?>
                          <div class="form-group row">
                            <div class="col-sm-2">
                            </div>
                            <label class="col-sm-2 col-form-label">New PIC : </label>
...
<?php echo $__env->make('admin.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web\konsultasi\resources\views/admin/changepic.blade.php ENDPATH**/ ?>