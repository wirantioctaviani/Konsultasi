...
<body>
    ...
    <?php if(session('errory')): ?>
     <div class="alert alert-danger alert-dismissible fade show" role="alert">
          <?php echo e(session('errory')); ?>
				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<form method="POST" action="<?php echo e(action('App\Http\Controllers\LoginController@otentikasi')); ?>">
                       		 <?php echo csrf_field(); ?>
...
<?php /**PATH D:\web\konsultasi\resources\views/admin/login.blade.php ENDPATH**/ ?>