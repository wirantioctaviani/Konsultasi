              ...
              <?php if($data_konsul_online->status_id == '3'): ?>
                <div class="panel-body">
                    <div class="col text-center">
                        <form class="form-prevent" action="<?php echo e(action('App\Http\Controllers\UsersController@closed_konsulonline', [$data_konsul_detail->id_konsul])); ?>" method="post">
                                        <?php echo e(csrf_field()); ?>
...
<?php /**PATH D:\webapp\webpusbin2021\public\konsultasi\resources\views/users/DetailKonsulOnline.blade.php ENDPATH**/ ?>