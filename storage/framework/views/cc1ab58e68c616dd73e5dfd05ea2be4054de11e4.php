        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
               <a href="<?php echo e(route('exportexcel')); ?>" class="btn btn-info">Export Excel</a>
               <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        ...
                        <tr>
                          ...
                          <?php if(request()->session()->get('level') == 3): ?>
                                ...
                                <?php endif; ?>
                          <?php elseif(request()->session()->get('level') == 4): ?>
                                <?php if($data_konsul_online -> status_id == 0 || $data_konsul_online -> status_id == 1): ?>
                                <td>
                                  <div class="btn-group-vertical">
                                ...
                                <?php endif; ?>
                          <?php elseif(request()->session()->get('level') == 1): ?>
                                <?php if($data_konsul_online -> status_id == 0 || $data_konsul_online -> status_id == 1): ?>
                                <td>
                                  <div class="btn-group-vertical">
                                    <a href="<?php echo e(action('App\Http\Controllers\AdminController@respon_konsulonline', [encrypt($data_konsul_online->id_konsul)])); ?>" class="btn btn-default">Detail</a>
                                ...
                                <?php endif; ?>
                          <?php elseif(request()->session()->get('level') == 2): ?>
...
<?php echo $__env->make('admin.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web\konsultasi\resources\views/admin/list_konsulonline2.blade.php ENDPATH**/ ?>