...
class UsersController extends Controller
{
	    	...
	    	if ($subbid_id == "11")
	    	{
							...
							if ($check == null){
									    ...
									    $request->file('dokumen')->move('dokumen/', $nama_file);}
									        ...
									        return redirect()->action('App\Http\Controllers\UsersController@konsul_online')->with('sukses', 'Form Berhasil di Submit!');
			}
    ...
    public function closed_konsulonline($id_konsul,Request $request)
    {
		...
		return redirect()->action('App\Http\Controllers\UsersController@list_konsul_online')->with('sukses', 'Case Closed!');
  ...
  //               	['updated_date' => date('Y-m-d H:i:s')]);
		...
		return redirect()->action('App\Http\Controllers\UsersController@list_konsul_online')->with('sukses', 'Respon Berhasil di Submit!');
    	#dd($request);
    }
